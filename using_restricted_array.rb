...
def length(array)
  ...
  until array[array_length] == nil do
    array_length += 1
  end
...
puts "Sorry, Shruti! I didn't have time but will finish this this week."
end
